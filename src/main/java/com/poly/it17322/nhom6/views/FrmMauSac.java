...
public class FrmMauSac extends javax.swing.JFrame {
    ...
    private void tblmausacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblmausacMouseClicked
        ...
        txtloai.setText(tblmausac.getValueAt(index, 0).toString());
        txtdungluong.setText(tblmausac.getValueAt(index, 1).toString());
    ...
    public void UpData() {
        ...
        m.setMa(txtloai.getText().trim());
        m.setTen(txtdungluong.getText().trim());
        if (mausac.insert(m)) {
