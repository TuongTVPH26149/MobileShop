 ...
 * @author admin
 */
public class ViewCPU extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCPU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
