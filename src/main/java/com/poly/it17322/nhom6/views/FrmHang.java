...
public class FrmHang extends javax.swing.JFrame {
    ...
    List<HangSPRespone> lsthang = new ArrayList<>();
    ...
    private void tblhangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblhangMouseClicked
        ...
        txtloai.setText(tblhang.getValueAt(index, 0).toString());
        txtdungluong.setText(tblhang.getValueAt(index, 1).toString());
    ...
    private void FilltoTableRam() {
        ...
        model.setRowCount(0);
        for (HangSPRespone x : hang.getlist()) {
    ...
    public void UpData() {
        ...
        HangSPRespone h = new HangSPRespone();
