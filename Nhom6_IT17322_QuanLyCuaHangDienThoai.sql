...
INSERT INTO ChucVu(Ma, Ten) VALUES ('QL', 'Admin'),
									('NV', 'NhanVien')
GO
INSERT INTO TrangThaiTaiKhoan(Ma, Ten) VALUES ('TT1', 'Con Lam')
GO
DECLARE @IdCV1 UNIQUEIDENTIFIER
SET @IdCV1 = (SELECT Id FROM ChucVu WHERE Ma = 'QL')
DECLARE @IdCV2 UNIQUEIDENTIFIER
SET @IdCV2 = (SELECT Id FROM ChucVu WHERE Ma = 'NV')
DECLARE @IdTT UNIQUEIDENTIFIER
SET @IdTT = (SELECT Id FROM TrangThaiTaiKhoan WHERE Ma = 'TT1')
INSERT INTO TaiKhoan(Ma, HoTen, Email, MatKhau, IdCV, IdTrangThaiTK) VALUES ('TK1', 'Nguyen Van A', 'admin@gmail.com', '21232F297A57A5A743894A0E4A801FC3', @IdCV1, @IdTT),
																			('TK2', 'Nguyen Van B', 'nhanvien@gmail.com', '2A2FA4FE2FA737F129EF2D127B861B7E', @IdCV2, @IdTT)
GO